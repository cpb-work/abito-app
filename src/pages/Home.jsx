            ...
            <div className="content-box">
              <div className="content-main">
                ...
                <div className="content-main__list">
                  {cardArray.map(card => <Card key={card.id} title={card.title} price={card.price} address={card.address} date={card.date} img={card.img} />)}
                </div>
              </div>
                ...
                <div className="content-side__box">
                  <div className="content-side__list">
                    ...
                    <div className="content-side__list-item">
                      <img
                        className="content-side__list-item--img"
                        src="/img/side-info-3.svg"
                        alt="side-info"
                      />
                      <h5 className="content-side__list-item--title">
                        Online бронирование жилья
                      </h5>
                      <p className="content-side__list-item--text">
                        Посуточная аренда квартир и домов: большой выборе
